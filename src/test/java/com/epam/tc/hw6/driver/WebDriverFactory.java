...
public final class WebDriverFactory {
    ...
    public static WebDriver createWebDriver(final String driverType, final String browserName) {
        if (REMOTE_DRIVER_TYPE.equalsIgnoreCase(driverType)) {
            ...
            throw new WebDriverTypeException(String.format("Illegal driver type: %s", driverType));
        }
    }

    private static WebDriver createLocalWebDriver(final String browserName) {
        WebDriver driver;
        switch (browserName.toLowerCase(Locale.ROOT)) {
            ...
            case FIREFOX:
                ...
                break;
            default:
                throw new IllegalArgumentException(String.format("Illegal browser: %s", browserName));
        }
        return driver;
    }
    ...
    private static WebDriver createRemoteWebDriver(final String browserName) {
        ...
        try {
            return new RemoteWebDriver(new URL("http://192.168.0.136:4444/wd/hub"), capabilities);
